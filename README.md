...
- `web:storybook`: runs storybook on `localhost:6006` for `web` workspace
- `web:build-storybook`: create the build version of storybook for `web` workspace
- `web:generate`: generate component files for `web` workspace
